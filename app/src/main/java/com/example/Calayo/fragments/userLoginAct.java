...
public class userLoginAct extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceStat) {
        View view = inflater.inflate(R.layout.user_login_act, container, false);
    ...
    protected void loginUser(View btn) {
        ...
        myAuth.signInWithEmailAndPassword(username,password).addOnCompleteListener(requireActivity(), task -> {
            if(task.isSuccessful()){
                ...
                Intent intent = new Intent(getContext(), UserDashboardAct.class); // Replace with actual target

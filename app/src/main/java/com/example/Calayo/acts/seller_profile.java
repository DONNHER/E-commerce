    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(view -> {
            ...
            if (user != null) {
                ...
                Intent homepage = new Intent(this, AdminLogin.class);
                ...
                Firebase.upload(this, selectedImageUri, fileName, new Firebase.UploadCallback() {
                    ...
                    public void onSuccess(String imageUrl) {
                        ...
                        reference.get().addOnCompleteListener(task -> {
                            ...
                            Toast.makeText(seller_profile.this, "Error", Toast.LENGTH_SHORT).show();
                        });
                    }

                    @Override
                    public void onFailure(String errorMessage) {
                        Toast.makeText(seller_profile.this, errorMessage, Toast.LENGTH_SHORT).show();
                    }
                });
